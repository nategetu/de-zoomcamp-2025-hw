...
```sql
SELECT pickup_zone, dropoff_zone, p90 FROM `kestrazoomcamp53378.dbt_ngetu.fct_fhv_monthly_zone_traveltime_p90` where pickup_zone in ('Newark Airport', 'SoHo', 'Yorkville East')
